...
},{"buffer":58,"type-detect":30}],30:[function(require,module,exports){
...
},{"./batcher":33}],35:[function(require,module,exports){
...
},{"./binding":34,"./config":36,"./deps-parser":37,"./directive":38,"./emitter":47,"./exp-parser":48,"./observer":51,"./text-parser":52,"./utils":54}],36:[function(require,module,exports){
var prefix = 'v',
    specialAttributes = [
        'pre',
        'ref',
...
},{"./emitter":47,"./observer":51,"./utils":54}],38:[function(require,module,exports){
var utils      = require('./utils'),
...
},{"./directives":41,"./filters":49,"./utils":54}],39:[function(require,module,exports){
...
},{"../config":36,"../transition":53}],41:[function(require,module,exports){
var utils      = require('../utils'),
    config     = require('../config'),
    transition = require('../transition')
...
},{"../config":36,"../transition":53,"../utils":54,"./html":39,"./if":40,"./model":42,"./on":43,"./repeat":44,"./style":45,"./with":46}],42:[function(require,module,exports){
var utils = require('../utils'),
...
},{"../config":36,"../observer":51,"../transition":53,"../utils":54,"../viewmodel":55}],45:[function(require,module,exports){
var camelRE = /-([a-z])/g,
...
},{"../viewmodel":55}],47:[function(require,module,exports){
function Emitter () {}
...
},{"./config":36,"./directives":41,"./filters":49,"./observer":51,"./transition":53,"./utils":54,"./viewmodel":55}],51:[function(require,module,exports){
/* jshint proto:true */
...
},{"./emitter":47,"./utils":54,"./viewmodel":55}],52:[function(require,module,exports){
var BINDING_RE = /{{{?([^{}]+?)}?}}/,
    TRIPLE_RE = /{{{[^{}]+}}}/
...
},{"./batcher":33,"./config":36}],54:[function(require,module,exports){
var config    = require('./config'),
    attrs     = config.attrs,
    toString  = ({}).toString,
    join      = [].join,
...
},{"./config":36,"./viewmodel":55}],55:[function(require,module,exports){
...
module.exports = ViewModel
},{"./batcher":33,"./compiler":35,"./transition":53,"./utils":54}],56:[function(require,module,exports){
/*jshint expr:true */
...
},{"../src/scripts/app":57,"chai":1}],57:[function(require,module,exports){
/*global Vue,$ */
...
var ListController = new Vue({
  ...
  methods: {
    ...
    toggleImportant: function(item) {
      ...
      console.log(item.task +" "+ item.complete +" "+ item.important)
    },
    addItem: function(txt) {
      this.items.push({task:txt, complete:false, important:false})
      $("#new-item-input").val("")
    }
  },
  created: function() {
...
},{"jquery":32,"vue":50}],58:[function(require,module,exports){
/**
